...
function item_validateData(){
	...
	if($j('#grupo').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Grupo:", close: function(){ /* */ $j('[name=grupo]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field serie can't be empty */
	if($j('#serie').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> S&#233;rie:", close: function(){ /* */ $j('[name=serie]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field tipologia can't be empty */
	if($j('#tipologia').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Tipologia / Esp&#233;cie:", close: function(){ /* */ $j('[name=tipologia]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function colecao_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field colecao can't be empty */
	if($j('#colecao').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Cole&#231;&#227;o:", close: function(){ /* */ $j('[name=colecao]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field codigo_colecao can't be empty */
	if($j('#codigo_colecao').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Codigo colecao", close: function(){ /* */ $j('[name=codigo_colecao]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function grupo_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field grupo can't be empty */
	if($j('#grupo').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Grupo:", close: function(){ /* */ $j('[name=grupo]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field codigo_grupo can't be empty */
	if($j('#codigo_grupo').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> C&#243;digo do Grupo:", close: function(){ /* */ $j('[name=codigo_grupo]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function serie_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field grupo can't be empty */
	if($j('#grupo').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Grupo:", close: function(){ /* */ $j('[name=grupo]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field serie can't be empty */
	if($j('#serie').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> S&#233;rie:", close: function(){ /* */ $j('[name=serie]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field codigo can't be empty */
	if($j('#codigo').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> C&#243;digo:", close: function(){ /* */ $j('[name=codigo]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function subserie_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field serie can't be empty */
	if($j('#serie').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> S&#233;rie:", close: function(){ /* */ $j('[name=serie]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field subserie can't be empty */
	if($j('#subserie').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Subs&#233;rie:", close: function(){ /* */ $j('[name=subserie]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function tipologia_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field tipologia can't be empty */
	if($j('#tipologia').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Tipologia:", close: function(){ /* */ $j('[name=tipologia]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function idioma_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field idioma can't be empty */
	if($j('#idioma').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Idioma:", close: function(){ /* */ $j('[name=idioma]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function local_comunicacao_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field local_comunicacao can't be empty */
	if($j('#local_comunicacao').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Local de Comunica&#231;&#227;o:", close: function(){ /* */ $j('[name=local_comunicacao]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function tipo_publicacao_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field tipo_publicacao can't be empty */
	if($j('#tipo_publicacao').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Tipo de Publica&#231;&#227;o:", close: function(){ /* */ $j('[name=tipo_publicacao]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function genero_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field genero can't be empty */
	if($j('#genero').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> G&#234;nero:", close: function(){ /* */ $j('[name=genero]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function formato_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field formato can't be empty */
	if($j('#formato').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Formato:", close: function(){ /* */ $j('[name=formato]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function suporte_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field suporte can't be empty */
	if($j('#suporte').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Suporte:", close: function(){ /* */ $j('[name=suporte]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function numero_caixa_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field numero_caixa can't be empty */
	if($j('#numero_caixa').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> N&#250;mero da Caixa:", close: function(){ /* */ $j('[name=numero_caixa]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function nome_caixa_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field numero_caixa can't be empty */
	if($j('#numero_caixa').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> N&#250;mero da Caixa:", close: function(){ /* */ $j('[name=numero_caixa]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field nome_caixa can't be empty */
	if($j('#nome_caixa').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Nome da Caixa:", close: function(){ /* */ $j('[name=nome_caixa]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function numero_pasta_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field numero_pasta can't be empty */
...
function nome_pasta_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field numero_pasta can't be empty */
	if($j('#numero_pasta').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> N&#250;mero da Pasta:", close: function(){ /* */ $j('[name=numero_pasta]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
...
function persist_expanded_child(id){
	var expand_these = JSON.parse(localStorage.getItem('Acervo_Frederico_Morais.dvp_expand'));
	...
	if($j('[id=' + id + ']').hasClass('active')){
		if(expand_these.indexOf(id) < 0){
			...
			localStorage.setItem('Acervo_Frederico_Morais.dvp_expand', JSON.stringify(expand_these));
		}
	}else{
		if(expand_these.indexOf(id) >= 0){
