<?php
	...
	$Translation['maintenance mode admin notification'] = 'O modo de manutenção está ativado. Você pode desabilita-lo na página de administração.';
	$Translation['maintenance mode message'] = 'Mensagem do modo de manutenção';
	$Translation['maintenance mode'] = 'Modo de Manutenção';
	$Translation['OFF'] = 'OFF';
	$Translation['ON'] = 'ON';
	$Translation['enable maintenance mode?'] = 'Você tem certeza que deseja habilitar o modo de manutenção? Somente administradores podem acessar o site neste modo!';
	$Translation['disable maintenance mode?'] = 'Você tem certeza que deseja desabilitar o modo de manutenção? Todos poderão ver o conteúdo do site.';
	
	/* Added in AppGini 5.60 */
	$Translation['csv file upload error'] = 'Um erro ocorreu durante o processamento do arquivo CSV.';
	$Translation['back and retry'] = 'Voltar e tentar novamente.';
	$Translation['upload or choose csv file'] = 'Upload do arquivo CSV ou abrir um existente.';
	$Translation['choose csv upload'] = 'Escolha um arquivo CSV para fazer o Upload';
	$Translation['no file chosen yet'] = 'Nenhum arquivo foi selecionado ainda';
	$Translation['start upload'] = 'Iniciar o Upload';
	$Translation['select a table'] = 'Selecione uma tabela';
	$Translation['error reading csv data'] = 'Um erro ocorreu durante a leitura do arquivo CSV. Tente reenviar / reajustar os ajustes do CSV.';
	$Translation['belongs to'] = 'Pertence à';
	$Translation['skip column'] = 'Pular esta coluna';
	$Translation['connection failed retrying'] = 'Falha na conexão. Tentando a conexão em <SECONDS> segundos ...';
	$Translation['connection failed timeout'] = 'Time out de conexão. Tente novamente.';
	$Translation['sure delete csv'] = 'Deseja apagar o aqrquivo CSV [CSVFILE] do servidor?';
	$Translation['invalid csv file selected'] = 'Arquivo CSV invalido. É preciso enviar um arquivo CSV válido.';
	$Translation['couldnt delete csv file'] = 'Não foi possível apagar o arquivo CSV.';
	$Translation['error backing up table'] = 'Erro: Não foi possível realizar o back up da tabela: <TABLE>.';
	$Translation['no columns selected'] = 'Por favor selecione ao menos uma coluna para importar e tenha certeza que ela pertença a um único campo.';
	$Translation['csrf token expired or invalid'] = 'Oops! Alguma coisa aconteceu. Por favor, volte e tente novamente.';
	$Translation['back to groups'] = 'Voltar aos grupos';
	$Translation['member updated'] = "O usuário <USERNAME> foi atualizado com sucesso.";
	$Translation['fix errors before submitting'] = 'Por favor, corrija os campos marcados com os erros antes de submeter a página.';

	/* Added in AppGini 5.62 */
	$Translation['mail_function'] = 'Método de envio de e-mails.';
	$Translation['smtp_server'] = 'Servidor SMTP';
	$Translation['smtp_encryption'] = 'Criptografia SMTP';
	$Translation['smtp_port'] = 'Porta SMTP';
	$Translation['smtp_port_hint'] = 'Valores padrão são 25 (para não criptografados SMTP), 465 (usados em grande maioria em conexões SSL) or 587 (típico de codificações TLS)';
	$Translation['smtp_user'] = 'SMTP username';
	$Translation['smtp_pass'] = 'SMTP password';
	$Translation['configure mail settings'] = 'Configurar os dados para e-mail.';
	$Translation['display debugging info'] = 'Mostrar informações de debug.';
	$Translation['debugging info hint'] = 'Op~ções de debugging são úteis quando se tem problemas de envio de e-mail.';

	/* Added in AppGini 5.70 */
	$Translation['create backup file'] = 'Criar um arquivo de back-up';
	$Translation['database backups'] = 'Backup de bancos de dados';
	$Translation['no backups found'] = 'Não foram encontrados back-ups; Você pode criar um arquivo de back-up clicando na opção Criar back-up.';
	$Translation['available backups'] = 'Back-ups disponíveis';
	$Translation['restore backup'] = 'Restore';
	$Translation['delete backup'] = 'Apagar';
	$Translation['backup restored'] = 'Back-up restaurado com sucesso.';
	$Translation['backup deleted'] = 'Back-up apagado com sucesso.';
	$Translation['restore error'] = 'Um erro aconteceu durante restaurando o back-up..';
	$Translation['backup delete error'] = 'Algum erro aconteceu na tentativa de apagar o back-up.';
	$Translation['confirm delete backup'] = 'Tem certeza que deseja apagar o arquivo de back-up?';
	...
	$Translation['fix all'] = 'CORRIGIR TODOS OS CAMPOS';
