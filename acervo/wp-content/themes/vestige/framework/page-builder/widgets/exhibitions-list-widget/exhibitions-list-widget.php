...
/*
Widget Name: imithemes - Exhibitions List/Grid Widget
Description: A widget to show Exhibitions list/grid view.
Author: imithemes
Author URI: http://imithemes.com
*/

class Exhibitions_List_Widget extends SiteOrigin_Widget {
	function __construct() {

		parent::__construct(
			'exhibitions-list-widget',
			esc_html__('imithemes - Exhibitions List/Grid Widget', 'vestige'),
			array(
				'description' => esc_html__('A widget to show Exhibitions list/grid view.', 'vestige'),
			...
			array(
				...
				'exhibition_status' => array(
					'type' => 'select',
					'state_name' => 'future',
					'prompt' => esc_html__( 'Exhibition Status', 'vestige' ),
					'options' => array(
						'future' => esc_html__( 'Future', 'vestige' ),
						'past' => esc_html__( 'Past', 'vestige' ),
					)
				),
				...
				'show_pagination' => array(
					'type' => 'checkbox',
					'default' => false,
					'label' => esc_html__('Show pagination for exhibitions per page? This will work on separate pages only and not on homepage.', 'vestige'),
				),
				'show_post_meta' => array(
					'type' => 'checkbox',
					'default' => true,
					'label' => esc_html__('Show post meta like exhibitions date/time, venue?', 'vestige'),
				),
...
siteorigin_widget_register('exhibitions-list-widget', __FILE__, 'Exhibitions_List_Widget');