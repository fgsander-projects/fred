...
$slug = $term->slug;
$term_link = get_term_link($term->slug, 'artwork-tags');
            ...
            <div class="row">
                <div class="col-md-<?php echo esc_attr($class); ?>" id="content-col">
                    ...
                    <div class="post-content">
                        <?php $term_desc = wp_trim_words(term_description($term->term_id, 'artwork-tags'));
                        if ($term_desc != '') {
                            echo '' . $term_desc;
                            echo '<hr class="fw">';
                        }
                    ...
                    <?php $artworks_arg = array('post_type' => 'artwork', 'artwork-tags' => $slug, 'posts_per_page' => -1);
