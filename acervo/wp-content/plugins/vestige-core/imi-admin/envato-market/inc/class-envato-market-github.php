	...
	class Envato_Market_Github {
		...
		public function notice() {
			...
			if ( 'deactivated' === $state ) {
				...
				$message = sprintf(
					esc_html__( '%1$sActivate the Envato Market plugin%2$s to get updates for your ThemeForest and CodeCanyon items.', 'vestige' ),
				...
				$message = sprintf(
					esc_html__( '%1$sInstall the Envato Market plugin%2$s to get updates for your ThemeForest and CodeCanyon items.', 'vestige' ),
