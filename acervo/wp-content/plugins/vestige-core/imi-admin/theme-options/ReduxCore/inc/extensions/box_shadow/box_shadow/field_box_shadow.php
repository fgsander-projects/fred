    ...
    class ReduxFramework_box_shadow extends ReduxFramework_extension_box_shadow
    {
        ...
        public function render()
        {
            ...
            if ($this->field['horizontal'] === true) {
                ...
                echo '<label>' . __('Offset X', 'vestige') . '</label>';
                echo '<span class="add-on"><i class="el el-resize-horizontal icon-large"></i></span>';
                echo '<input type="text" class="redux-shadow-input redux-shadow-horizontal mini ' . $this->field['class'] . '" placeholder="' . __('X', 'vestige') . '" rel="' . $this->field['id'] . '-horizontal" value="' . filter_var($this->value['horizontal'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
            ...
            if ($this->field['vertical'] === true) {
                ...
                echo '<div class="field-shadow-input input-prepend">';
                echo '<label>' . __('Offset Y', 'vestige') . '</label>';
                echo '<span class="add-on"><i class="el el-resize-vertical icon-large"></i></span>';
                echo '<input type="text" class="redux-shadow-input redux-shadow-vertical mini ' . $this->field['class'] . '" placeholder="' . __('Y', 'vestige') . '" rel="' . $this->field['id'] . '-vertical" value="' . filter_var($this->value['vertical'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
            ...
            if ($this->field['blur'] === true) {
                ...
                echo '<div class="field-shadow-input input-prepend">';
                echo '<label>' . __('Blur Radius', 'vestige') . '</label>';
                echo '<span class="add-on"><i class="el el-adjust icon-large"></i></span>';
                echo '<input type="text" class="redux-shadow-input redux-shadow-blur mini ' . $this->field['class'] . '" placeholder="' . __('Blur', 'vestige') . '" rel="' . $this->field['id'] . '-blur" value="' . filter_var($this->value['blur'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
            ...
            if ($this->field['spread'] === true) {
                ...
                echo '<div class="field-shadow-input input-prepend">';
                echo '<label>' . __('Spread Radius', 'vestige') . '</label>';
                echo '<span class="add-on"><i class="el el-idea icon-large"></i></span>';
                echo '<input type="text" class="redux-shadow-input redux-shadow-spread mini ' . $this->field['class'] . '" placeholder="' . __('Spread', 'vestige') . '" rel="' . $this->field['id'] . '-spread" value="' . filter_var($this->value['spread'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
            ...
            if ($this->field['opacity'] === true) {
                ...
                echo '<div class="field-shadow-input input-prepend">';
                echo '<label>' . __('Opacity .1 - 1', 'vestige') . '</label>';
                echo '<span class="add-on"><i class="el el-idea icon-large"></i></span>';
                echo '<input type="text" class="redux-shadow-input redux-shadow-opacity mini ' . $this->field['class'] . '" placeholder="' . __('Opacity', 'vestige') . '" rel="' . $this->field['id'] . '-opacity" value="' . filter_var($this->value['opacity'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION) . '">';
            ...
            if (isset($this->field['units']) && $this->field['units'] !== false) {
                echo '<div class="shadow-units" original-title="' . __('Units', 'vestige') . '">';
                echo '<label>' . __('Units', 'vestige') . '</label>';
                echo '<select data-id="' . $this->field['id'] . '" data-placeholder="' . __('Units', 'vestige') . '" class="redux-shadow redux-shadow-units select ' . $this->field['class'] . '" original-title="' . __('Units', 'vestige') . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[units]' . '">';
            ...
            if ($this->field['shadow-color'] === true) {
                ...
                echo '<div class="shadow-color" original-title="' . __('Shadow Color', 'vestige') . '">';
                echo '<label>' . __('Shadow Color', 'vestige') . '</label>';
            ...
            if ($this->field['shadow-type'] === true) {
                ...
                echo '<div class="shadow-type" original-title="' . __('Shadow Type', 'vestige') . '">';
                echo '<label>' . __('Shadow Type', 'vestige') . '</label>';
                echo '<select id="' . $this->field['id'] . '-shadow-type-select" data-placeholder="' . __('Shadow Type', 'vestige') . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[shadow-type]" class="redux-select-item redux-background-input redux-shadow-type ' . $this->field['class'] . '">';
                echo '<option></option>';
            ...
            if ($this->field['preview'] === true) {
                ...
                echo '<div class="clearfix"></div><div class="shadow-previewer" original-title="' . __('Shadow Preview', 'vestige') . '">';
