		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				...
				'colecao' => array(
					'Caption' => 'Cole&#231;&#227;o',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/document_copies.png',
					'group' => $tg[1],
					'homepageShowCount' => 0
				),
				'grupo' => array(
				...
				'tipologia' => array(
					'Caption' => 'Tipologia / Esp&#233;cie',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/document_layout.png',
					'group' => $tg[2],
					'homepageShowCount' => 0
				),
				'idioma' => array(
				...
				'local_comunicacao' => array(
					'Caption' => 'Local de Comunica&#231;&#227;o',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/column_right.png',
					'group' => $tg[2],
					'homepageShowCount' => 0
				),
				'tipo_publicacao' => array(
					'Caption' => 'Tipo de Publica&#231;&#227;o',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/column_right.png',
					'group' => $tg[2],
					'homepageShowCount' => 0
				...
				'genero' => array(
					'Caption' => 'G&#234;nero',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/document_info.png',
					'group' => $tg[2],
					'homepageShowCount' => 0
				),
				'formato' => array(
				...
				'numero_caixa' => array(
					'Caption' => 'N&#250;mero da Caixa',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/box_front.png',
					'group' => $tg[3],
					'homepageShowCount' => 0
				),
				'nome_caixa' => array(
					'Caption' => 'Nome da Caixa',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/box_front.png',
					'group' => $tg[3],
					'homepageShowCount' => 0
	...
	if(!function_exists('getTableList')){
		function getTableList($skip_authentication = false){
			$arrTables = array(   
				...
				'serie' => 'S&#233;rie',
				'subserie' => 'Subs&#233;rie',
				'tipologia' => 'Tipologia / Esp&#233;cie',
				'idioma' => 'Idioma',
				'local_comunicacao' => 'Local de Comunica&#231;&#227;o',
