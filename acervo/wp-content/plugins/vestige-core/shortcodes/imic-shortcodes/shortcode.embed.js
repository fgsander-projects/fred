function embedSelectedShortcode() {
	...
	if (current_shortcode != -1) {
		...
		if (shortcode_select == 'shortcode-video') {
			shortcodeHTML = '<br/>[video url="'+video_url+'" width="'+video_width+'" height="'+video_height+'" full="'+video_full_width+'"]<br/>';	
		}
		...
		if (shortcode_select == 'shortcode-form') {
			shortcodeHTML = '<br/>[imic_form form_title="'+form_title+'"]<br/>';	
		}
                 /////////////////////////////////////////
		////	Event Calendar SHORTCODE OUTPUT
		/////////////////////////////////////////
		if (shortcode_select == 'shortcode-calendar') {
			shortcodeHTML = '<br/>[event_calendar]<br/>';
                       
		}
		
		         /////////////////////////////////////////
		////	Exhibition Calendar SHORTCODE OUTPUT
		/////////////////////////////////////////
		if (shortcode_select == 'shortcode-calendar-exhibition') {
			shortcodeHTML = '<br/>[exhibition_calendar]<br/>';
		...
		if (shortcode_select == 'shortcode-icons-box') {
			shortcodeHTML = '[icon_box icon_image="'+icon_box_image+'" title="'+icon_title+'" description="'+icon_description+'" link="'+icon_link+'" type="'+icon_type+'" shade="'+icon_shade+'" effect="'+icon_effect+'" box="'+icon_box+'" outline="'+icon_outline+'"]';	
		}
		...
		if (shortcode_select == 'shortcode-typography') {
			switch (typography_type){
				...
				case 'typo-div':	shortcodeHTML = '<br/>[div extra="'+div_xclass+'"][/div]<br/>'; break;
				case 'typo-spacer':	shortcodeHTML = '<br/>[spacer size="'+spacer_class+'" extra="'+spacer_xclass+'"][/spacer]<br/>'; break;
			}	
		}
		...
		if (shortcode_select == 'shortcode-columns' && column_options == '') {
			shortcodeHTML = '<br/>[custom extra="'+ column_xclass +'" anim="'+column_animation+'"]1/4 Text[/custom]<br/>';	
		}
