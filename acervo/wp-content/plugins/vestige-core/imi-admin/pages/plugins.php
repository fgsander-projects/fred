			...
			foreach( $plugins as $plugin ) :
				...
				<div class="theme <?php echo esc_attr( $plugin_status ); ?>">
					...
					<?php if ( $plugin['type'] == 'Required' ) : ?>
						<div class="plugin-requirement plugin-required"><?php esc_html_e( 'REQUIRED', 'vestige-core' ); ?></div>
					<?php else: ?>
						<div class="plugin-requirement"><?php esc_html_e( 'OPTIONAL', 'vestige-core' ); ?></div>
					<?php endif; ?>

					<div class="theme-screenshot">
						<img src="<?php echo esc_url( $plugin['image_src'] ); ?>" alt="Plugin">
					</div>
