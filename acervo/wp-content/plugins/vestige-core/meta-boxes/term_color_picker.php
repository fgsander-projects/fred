...
?>
<tr class="form-field">
    <th scope="row" valign="top"><label for="meta-color"><?php esc_html_e('Category Name Background Color','vestige'); ?></label></th>
    <td>
        <div id="colorpicker">
...
function imic_colorpicker_enqueue() {
    ...
    wp_enqueue_script( 'colorpicker-js', get_template_directory_uri() . '/assets/js/colorpicker.js', array( 'wp-color-picker' ) );
}
