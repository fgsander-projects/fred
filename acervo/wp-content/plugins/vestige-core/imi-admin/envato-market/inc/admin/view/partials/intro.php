...
<div class="col">
	...
	<p><?php esc_html_e( 'Welcome!', 'vestige' ); ?></p>
	<p><?php esc_html_e( 'This plugin can install WordPress themes and plugins purchased from ThemeForest & CodeCanyon by connecting with the Envato Market API using a secure OAuth personal token. Once your themes & plugins are installed WordPress will periodically check for updates, so keeping your items up to date is as simple as a few clicks.', 'vestige' ); ?></p>
	<p><strong><?php printf( esc_html__( 'Find out more at %1$senvato.com%2$s.', 'vestige' ), '<a href="https://envato.com/market-plugin/" target="_blank">', '</a>' ); ?></strong></p>
</div>
