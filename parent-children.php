		...
		$pcConfig = array(
			'item' => array(   
				'colecao' => array(   
					...
					'sortable-fields' => array(0 => '`item`.`id`', 1 => 2, 2 => '`item`.`numero_serie`', 3 => '`colecao1`.`colecao`', 4 => '`colecao1`.`codigo_colecao`', 5 => '`grupo1`.`grupo`', 6 => '`grupo1`.`codigo_grupo`', 7 => '`serie1`.`serie`', 8 => '`serie1`.`codigo`', 9 => '`subserie1`.`subserie`', 10 => 11, 11 => 12, 12 => 13, 13 => '`tipologia1`.`tipologia`', 14 => '`item`.`date`', 15 => 16, 16 => 17, 17 => 18, 18 => 19, 19 => 20, 20 => 21, 21 => '`local_comunicacao1`.`local_comunicacao`', 22 => 23, 23 => '`tipo_publicacao1`.`tipo_publicacao`', 24 => 25, 25 => 26, 26 => '`formato1`.`formato`', 27 => 28, 28 => '`suporte1`.`suporte`', 29 => 30, 30 => 31, 31 => 32, 32 => 33, 33 => '`numero_caixa1`.`numero_caixa`', 34 => '`nome_caixa1`.`nome_caixa`', 35 => '`numero_pasta1`.`numero_pasta`', 36 => '`nome_pasta1`.`nome_pasta`', 37 => 38, 38 => 39, 39 => 40, 40 => 41, 41 => 42),
					'records-per-page' => 10,
					'default-sort-by' => 0,
