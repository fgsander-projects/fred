...
class next_exhibitions extends WP_Widget {
	// constructor
	public function __construct() {
		 $widget_ops = array('description' => esc_html__( 'Display upcoming exhibitions.','vestige') );
         parent::__construct(false, $name = esc_html__('Upcoming Exhibitions','vestige'), $widget_ops);
	}
	...
	?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title', 'vestige'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php _e('Number of events to show', 'vestige'); ?></label>
...
add_action( 'widgets_init', function(){
	register_widget( 'next_exhibitions' );
});
?>