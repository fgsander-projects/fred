	...
	*/
	...
	$schema = array(   
		'item' => array(   
			...
			'tipo_publicacao' => array('appgini' => 'INT unsigned null '),
			...
			'grupo_codigo' => array('appgini' => 'INT unsigned null '),
			...
			'numero_serie' => array('appgini' => 'INT null unique '),
			'tipologia' => array('appgini' => 'INT unsigned not null '),
			'genero' => array('appgini' => 'INT unsigned null '),
			'forma' => array('appgini' => 'TEXT null '),
			'formato' => array('appgini' => 'INT unsigned null '),
			'escritura' => array('appgini' => 'TEXT null '),
			'suporte' => array('appgini' => 'INT unsigned null '),
			'dimensao' => array('appgini' => 'VARCHAR(120) null '),
			'estado_conservacao' => array('appgini' => 'TEXT null '),
			'observacoes' => array('appgini' => 'TEXT null '),
			'documentos_relacionados' => array('appgini' => 'INT unsigned null '),
			'numero_caixa' => array('appgini' => 'INT unsigned null '),
			'nome_caixa' => array('appgini' => 'INT unsigned null '),
			'numero_pasta' => array('appgini' => 'INT unsigned null '),
			'nome_pasta' => array('appgini' => 'INT unsigned null '),
			'upload' => array('appgini' => 'VARCHAR(40) null '),
			'usuario_cadastro' => array('appgini' => 'VARCHAR(80) null '),
			'usuario_alteracao' => array('appgini' => 'VARCHAR(80) null '),
			'publicar' => array('appgini' => 'VARCHAR(40) null ')
		),
		'colecao' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'colecao' => array('appgini' => 'VARCHAR(80) not null '),
			'codigo_colecao' => array('appgini' => 'VARCHAR(20) not null ')
		),
		'grupo' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'colecao' => array('appgini' => 'INT unsigned null '),
			'grupo' => array('appgini' => 'VARCHAR(80) not null '),
			'codigo_grupo' => array('appgini' => 'VARCHAR(20) not null unique ')
		),
		'serie' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'grupo' => array('appgini' => 'INT unsigned not null '),
			'serie' => array('appgini' => 'VARCHAR(80) not null '),
			'codigo' => array('appgini' => 'INT(2) zerofill not null ')
		),
		'subserie' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'serie' => array('appgini' => 'INT unsigned not null '),
			'subserie' => array('appgini' => 'VARCHAR(80) not null ')
		),
		'tipologia' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'tipologia' => array('appgini' => 'VARCHAR(80) not null unique ')
		),
		'idioma' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'idioma' => array('appgini' => 'VARCHAR(80) not null unique ')
		),
		'local_comunicacao' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'local_comunicacao' => array('appgini' => 'VARCHAR(80) not null unique ')
		),
		'tipo_publicacao' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'tipo_publicacao' => array('appgini' => 'VARCHAR(80) not null unique ')
		),
		'genero' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'genero' => array('appgini' => 'VARCHAR(80) not null unique ')
		),
		'formato' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'formato' => array('appgini' => 'VARCHAR(80) not null unique ')
		),
		'suporte' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'suporte' => array('appgini' => 'VARCHAR(80) not null unique ')
		),
		'numero_caixa' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'numero_caixa' => array('appgini' => 'VARCHAR(80) not null unique ')
		),
		'nome_caixa' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'numero_caixa' => array('appgini' => 'INT unsigned not null '),
			'nome_caixa' => array('appgini' => 'TEXT not null ')
		),
		'numero_pasta' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'numero_pasta' => array('appgini' => 'VARCHAR(80) not null unique ')
		),
		'nome_pasta' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
