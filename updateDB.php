<?php
	...
	if($thisMD5==$prevMD5){
		...
		// set up tables
		setupTable('item', "create table if not exists `item` (   `id` INT unsigned not null auto_increment , primary key (`id`), `identificacao` VARCHAR(80) not null , unique `identificacao_unique` (`identificacao`), `colecao` INT unsigned not null , `colecao_codigo` INT unsigned null , `grupo` INT unsigned not null , `grupo_codigo` INT unsigned null , `serie` INT unsigned not null , `serie_codigo` INT unsigned null , `subserie` INT unsigned null , `numero_serie` INT null , unique `numero_serie_unique` (`numero_serie`), `tipologia` INT unsigned not null , `descricao` TEXT null , `titulo` TEXT null , `titulo_atribuido` VARCHAR(40) null , `date` DATE null , `data_livre` VARCHAR(120) null , `data_atribuida` VARCHAR(40) null , `autoria` TEXT null , `quantidade` VARCHAR(40) null , `idioma` INT unsigned null , `local_producao` TEXT null , `local_publicacao_veiculo` INT unsigned null , `local_publicacao` TEXT null , `tipo_publicacao` INT unsigned null , `genero` INT unsigned null , `forma` TEXT null , `formato` INT unsigned null , `escritura` TEXT null , `suporte` INT unsigned null , `dimensao` VARCHAR(120) null , `estado_conservacao` TEXT null , `observacoes` TEXT null , `documentos_relacionados` INT unsigned null , `numero_caixa` INT unsigned null , `nome_caixa` INT unsigned null , `numero_pasta` INT unsigned null , `nome_pasta` INT unsigned null , `upload` VARCHAR(40) null , `usuario_cadastro` VARCHAR(80) null , `usuario_alteracao` VARCHAR(80) null , `publicar` VARCHAR(40) null ) CHARSET utf8", $silent);
