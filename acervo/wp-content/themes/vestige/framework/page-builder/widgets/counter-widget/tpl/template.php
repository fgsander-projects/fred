...
<div class="timer" data-perc="<?php echo esc_attr($number); ?>"> <span class="count" style="color:<?php echo esc_attr($ncolor); ?>"><?php echo esc_attr($number); ?></span> </div>
<div class="clearfix"></div>
<span class="fact" style="color:<?php echo esc_attr($tcolor); ?>"><?php echo esc_attr($text); ?></span>
</div>